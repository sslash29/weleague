...
function ViewSuspensionStatistics({ teamData }) {
  return (
    <div className="relative w-full border h-[700px] rounded-lg">
      {/* Header */}
      <div className="grid grid-cols-5 bg-[#F2F2F2] rounded-lg mb-5 px-4 py-3 items-center">
        <h2 className="text-4xl font-bold">Teams</h2>
        <span className="text-2xl text-center">Yellow Cards</span>
        <span className="text-2xl text-center">Red Cards</span>
...
export default ViewSuspensionStatistics;
